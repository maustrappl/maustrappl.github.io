...
let sights = L.geoJson.ajax(sightUrl, {  //punkte werden als marker gesetzt
    pointToLayer: function(point, latlng) { // beschreibt, welcher Marker produziert werden soll
        let icon = L.icon({
